...
APPID = '5c2b4dfe'  # 替换为你的APPID

APIKEY = 'd563f2f24592e30a9d0b5a86f603172b'  # 替换为你的APIKey

APISECRET = 'NWYzY2VhNzk2OWFhNjM4YzlkNjg2ZDkw'  # 替换为你的APISecret
    ...
    def __init__(self, APPID, APIKey, APISecret, Text):
        ...
        self.BusinessArgs = {
            ...
            "tts": {
                ...
                "vcn": "x5_lingyuzhao_flow", # 语音合成模型，可参考 https://www.xfyun.cn/services/smart-tts
    ...
    try:
        ...
        if HAS_PYGAME:
            ...
            if system == "Windows":
                ...
                # 使用afplay播放，并等待播放完成
                import subprocess
                subprocess.run(['afplay', abs_path], check=True)
...
def text_to_speech(text):
    ...
    try:
        ...
        if os.path.exists(tts_audio_file) and os.path.getsize(tts_audio_file) > 0:
            ...
            print(f"✅ 音频文件已生成: {tts_audio_file}")
            ...
            print(f"❌ 音频文件未生成或为空: {tts_audio_file}")
...
if __name__ == "__main__":
    # 检查API配置
    if APPID == 'APPID' or APIKEY == 'APIKEY' or APISECRET == 'APISECRET':
        print("⚠️  警告：请先配置科大讯飞API信息！")
        print("请在代码中修改以下变量：")
        print("  - APPID")
        print("  - APIKEY")
        print("  - APISECRET")
        print("  - REQURL（如果需要）")
        print("\n配置完成后，可以调用 text_to_speech('要转换的文本') 来使用TTS功能。")
    else:
        print("✅ API配置已设置")
        print("开始测试TTS功能...")
        # 测试TTS功能
        text_to_speech("你好，这是科大讯飞语音合成测试")
